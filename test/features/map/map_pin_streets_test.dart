...
void main() {
  ...
  test('lone label name is ru, not copied into en or kk', () {
    final names = streetNamesFromFeature(
      _road(
        name: 'проезд Дуйсена Суйесинова',
        lng: 51.9,
        lat: 47.12,
      ),
    );
  ...
  test('pickNearbyStreets does not store an English label in ru', () {
    final streets = pickNearbyStreets(
      [
        _road(
          name: 'Duysen Suyesinov crossing',
          lng: 51.90007,
          lat: 47.12007,
        ),
        _road(
  ...
  test('choosePinStreets preselects the reverse street when it is on the tile', () {
  ...
  test('choosePinStreets inserts reverse when tiles do not contain it', () {
    ...
    const tiles = [
      LocalizedNames(ru: 'проезд Дуйсена Суйесинова'),
    ];
